...
Eine entkoppelte Schnittstelle zwischen Frontend und Backend ermöglicht klassische Serverumgebungen und künftig auch dezentrale, verschlüsselte oder local-first Architekturen.
...
Wir arbeiten seit Jahren an Software für den gesellschaftlichen Wandel da wir oft erlebt haben, wie Initiativen an unpassenden Tools scheitern. Nicht selten sind ganze Gruppen in endlosen Chats hängen bleiben, während die Energie vor Ort verloren geht.

Darum wollen wir Netzwerke sichtbar machen – die Menschen, Orte, Aktivitäten und Ressourcen, die Gemeinschaft entstehen lassen – und zugleich die Privatsphäre solcher Daten schützen, denn Vertrauen ist die Basis jeder Zusammenarbeit.

Aus diesen Erfahrungen heraus entwickeln wir Real-Life Stack: eine modulare Infrastruktur, die Communities befähigt, passende Werkzeuge bereitzustellen – und damit Menschen einzuladen, den Bildschirm zu verlassen und gemeinsam vor Ort aktiv zu werden.
...
In der Second Stage wollen wir uns intensiv auf die Zusammenarbeit mit realen Communities konzentrieren. Wir arbeiten direkt mit verschiedenen Gruppen zusammen und unterstützen sie bei der Einführung unserer Software und beobachten gemeinsam, wie sie sie im Alltag nutzen.
