...
- [x] **lens-switch-transition**: Der Wechsel der aktiven Linse ist eine React-Transition — die Auslöse-Fläche bleibt sofort responsiv, der schwere Mount der Ziel-Linse rendert nachgelagert; Flächen-Linsen entlasten lange Bestände beim Rendern (content-visibility, ab großen Beständen Virtualisierung)
